...
export const WelcomeOverlay = ({ username, onDone }: WelcomeOverlayProps) => {
    ...
    return (
        ...
        >
            <div
                ref={panelLeftRef}
                className="absolute top-0 bottom-0 left-0 w-1/2 flex items-center justify-center"
                style={{
                    background: '#e07a5f',
            ...
            <div
                ref={panelRightRef}
                className="absolute top-0 bottom-0 right-0 w-1/2 flex items-center justify-center"
                style={{
                    background: '#81b29a',
            ...
            >
                <div className="w-24 h-24 md:w-28 md:h-28 rounded-full bg-white border-4 border-[#e07a5f] mb-6
                ...
                <h2 className="text-5xl md:text-6xl font-black text-white tracking-tighter drop-shadow-2xl mb-4">
                    Halo, <span className="text-[#f6d195] drop-shadow-lg">{username}</span>!
                </h2>

                <p className="text-base md:text-lg text-white/95 font-bold drop-shadow-md">
                    Sistem siap, yuk pantau cuan lu
                </p>
            </div>
        </div>
    );
