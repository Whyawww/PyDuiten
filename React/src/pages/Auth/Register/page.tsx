    ...
    return (
        <AuthLayout title="Gabung PyDuiten Sekarang!" subtitle="Satu langkah lagi buat tobat finansial. Daftarin diri lu di bawah.">
            <form onSubmit={(e) => e.preventDefault()} className="w-full">
                ...
                <button className="w-full bg-primary text-white font-bold px-6 py-4 rounded-2xl shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300 active:scale-95 mt-4 mb-6">
                    Buat Akun
                </button>
